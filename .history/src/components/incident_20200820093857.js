...
const createRowData = ({
  ...
  name,
    severity,
    primaryParticipant: getPrimaryParticipant(participants),
    participants,
    statusId,
    duration,
    createdOn,
...
const Incident = ({ incidentData }) => {
  ...
  return (
    <TableRow key={rowData.name}>
      ...
      <TableCell align="right">{rowData.severity}</TableCell>
      <TableCell align="right">{rowData.primaryParticipant.user.realName}</TableCell>
